...
UI_STRINGS = [
 ...
 "Show the red card",
 "One tap presents a full-screen card the whole kitchen can read.",
 "Share by link",
 "Your whole profile is encoded in the card's link. Copy it and anyone can open the card on their own phone.",
 "GET STARTED",
